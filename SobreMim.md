...
Faço análise de dados! Trabalho com organização e cuidado de dados, ajudando instituições a usarem informações de forma ética, segura e inclusiva. No CIDACS/Fiocruz, lidero uma equipe que lida com grandes bases de dados para melhorar políticas públicas. Tenho doutorado em Ciências Sociais Aplicadas e gosto de juntar tecnologia, proteção de dados e diversidade nos projetos que desenvolvo.
...
* Research:
	...
	Epidemiology and Information at [CoVida Network– Science, Information, and Solidarity](https://cidacs.bahia.fiocruz.br/redecovida/sobre/page/15/). A scientific and multidisciplinary collaboration project focused on the Covid-19 pandemic (past - 2020-2021).
...
2025
* Data and Policy for Digital Inclusion in Administrative Data - [Daptiva](https://github.com/MairaLimaS/Dapiva)
  - Digital inclusion by design. [Maturity radar for administrative data prototipe](https://mairalmas.shinyapps.io/auroraBta_eng/).
